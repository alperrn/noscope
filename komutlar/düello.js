...
module.exports = {
  ...
  this.fighting = new Set();
    ...
    if (!opponent) return message.reply("`Birisini Etiketlemelisin`")
  
  if (opponent.bot) return message.reply('`Botlar İle Düello Atamazsın`');
            ...
            while (userHP > 0 && oppoHP > 0) { // eslint-disable-line no-unmodified-loop-condition
                ...
                if (choice === 'saldır') {
                    ...
                    if (!miss) {
                        ...
                        await message.channel.send(`${user}, Çoook Uzak Galaksilerden Gelen Ultra Sonik Enerjiyi Yeterli Miktarda Toplayamadığın İçin Ulta Güç Kullanamadın!`);
                    }
                    reset();
                } else if (choice === 'kaç') {
